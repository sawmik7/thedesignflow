      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-28 items-center">
          ...
          <div className="about-video-col relative order-2 lg:order-1" style={{ perspective: "1000px" }}>
            ...
            {/* Video card */}
            <div className="relative w-full max-w-md aspect-[3/4] rounded-none overflow-hidden mx-auto lg:mx-0 group shadow-[0_60px_120px_-30px_rgba(0,0,0,0.7)]">
              ...
              {/* Border glow */}
              <div className="absolute inset-0 z-20 rounded-none ring-1 ring-white/10 group-hover:ring-[var(--brand-orange)]/20 transition-all duration-700 pointer-events-none" />
          ...
          <div className="about-text-col order-1 lg:order-2">
            ...
            <div className="mb-10 w-full max-w-full">
              <div className="overflow-hidden pb-4 w-full">
                <div className="about-headline-line font-hero text-[clamp(2.5rem,4.5vw,4.5rem)] font-light leading-[1.1] text-white">
                  We build <span className="text-[var(--brand-orange)] italic">autonomous</span>
                </div>
              </div>
              <div className="overflow-hidden pb-4 w-full">
                <div className="about-headline-line font-hero text-[clamp(2.5rem,4.5vw,4.5rem)] font-light leading-[1.1] text-white/40">
                  growth machines.
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6 max-w-xl mb-12">
              <p className="about-para text-white/50 text-lg leading-relaxed font-light italic">
                "In a world of noise, we create the signals. We don't just build websites; we architect industry-defining icons that command attention and drive undeniable results."
              </p>
              <p className="about-para text-white/40 text-sm leading-relaxed">
                Defining the next generation of digital excellence through AI and design. Transforming startups into market leaders with data-driven aesthetics.
              </p>
            </div>
